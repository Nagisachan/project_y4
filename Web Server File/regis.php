...
<div class="text-center" style="padding:50px 0">
	...
	<div class="login-form-1">
		<form id="register-form" class="text-left" action="http://thaiautotag.win/registration.php" method="POST">
			...
			<div class="etc-login-form">
				<p>already have an account? <a href="http://www.thaiautotag.win/login.php">login here</a></p>
			</div>
		</form>
	</div>
	<!-- end:Main Form -->
