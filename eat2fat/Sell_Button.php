<?php
	...
	else
	{
		...
		if($out['count'] == "1")
		{
			...
			$sql = "INSERT INTO tb_user_log (userLogNo, userID, actionCode, foodID, quantity) VALUES((SELECT CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(ul.userLogNo) END + 1 FROM tb_user_log ul), '" . $userID . "', (SELECT actionCode FROM tb_action_log WHERE actionName = 'Sell'), '" . $foodID . "', " . $quantity . ")";
			$result = mysqli_query($con, $sql);
