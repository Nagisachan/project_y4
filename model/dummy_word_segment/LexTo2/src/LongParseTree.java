...
public class LongParseTree {
  ...
  private Vector<Integer> indexList;        //List of index positions
  private Vector<Integer> typeList;         //List of word types
  private Vector<String> frontDepChar;     //Front dependent characters: must have front characters
  private Vector<String> rearDepChar;      //Rear dependent characters: must have rear characters
  private Vector<String> tonalChar;        //Tonal characters
  private Vector<String> endingChar;       //Ending characters
      
  /*******************************************************************/
  /************************ Constructor ******************************/
  /*******************************************************************/
  public LongParseTree(Trie dict, Vector<Integer> indexList, Vector<Integer> typeList) throws IOException {
  	
    this.dict=dict;
    this.indexList=indexList;
    this.typeList=typeList;
     
    frontDepChar=new Vector<String>();
    rearDepChar=new Vector<String>();
    tonalChar=new Vector<String>();
    endingChar=new Vector<String>();
