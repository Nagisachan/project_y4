...
public class LongLexTo {
	...
	// Returned variables
	private Vector<Integer> indexList; // List of word index positions
	private Vector<Integer> lineList; // List of line index positions
	private Vector<Integer> typeList; // List of word types (for word only)
	private Iterator<Integer> iter; // Iterator for indexList OR lineList
									// (depends on the
	// call)
	...
	/*********************** Return type list *************************/
	/*******************************************************************/
	public Vector<Integer> getTypeList() {
		return typeList;
	}
