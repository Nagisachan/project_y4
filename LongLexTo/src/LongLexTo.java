...
public class LongLexTo {
  ...
  public static void main(String[] args) throws IOException {
    ...
    LongLexTo tokenizer=new LongLexTo(new File("C:/Users/ZarkZ/workspace/LongLexTo/src/lexitron.txt"));
...
//	    while((line=br.readLine())!=null) {
	    ...
	    fw.write("<font color=#0000bb>ambiguous</font> | ");
	    fw.write("<font color=#a00aa>English/Digits</font> | ");
	    fw.write("<font color=#00aaaa>special</font></body></html>\n");
	 //   fr.close();
	    fw.close();
	    System.out.println("\n *** Status: Use Web browser to view result: " + outFileName);
	...
	//
	  LongLexTo tokenizer=new LongLexTo(new File("lexitron.txt"));
	  tokenizer.genOutput("ประกาศแจ้ง ข่าว (เส้นทางที่เป็นปัญหาด้านการจราจรในช่วงเวลานี้) ถนนพระราม6 ช่วงพงษ์พระราม มุ่งหน้าอุรุพงษ์ ปริมาณรถมากเคลื่อนตัวได้ช้า , ถนนลาดพร้าว ช่วงรัชดาลาดพร้าว มุ่งหน้าโชคชัย4 ปริมาณรถมากเคลื่อนตัวได้ช้า , แจ้งให้ทราบไว้เป็นข้อมูล วันที่07/09/2009 17:54:46 ","nat.html");
	} //main
}